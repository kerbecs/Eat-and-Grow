"""
------------------------------------------------------------------
                  Eat and Grow Version VIII ( The Menu)
------------------------------------------------------------------
"""
...
class Window:
    ...
    def add_text_creator(self):
        ...
        text_dimension1 = text_font.size(self.__creator[0])
        text_dimension2 = text_font.size(self.__creator[1])
    ...
    def display_window(self):
        ...
        while self.running:
            if not self.start_game:
                ...
                Version9_game.start(self,Window.window_size)
                self.start_game = False
            display.update()
