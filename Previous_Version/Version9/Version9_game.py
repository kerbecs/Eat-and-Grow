...
class Game:
    ...
    def __init__(self, window, window_size):
        ...
        self.__text = "ME"
        self.__text_size= 15
        self.text_size_font = "Jokerman"
        self.text_size_color = "aqua"
    ...
    def add_text(self):
        ...
        Game.window_surface.blit(title_font.render(self.__text, True, self.text_color),
                                 (self.__player_circle_coords[0]-text_dimension[0]/2, self.__player_circle_coords[1]-text_dimension[1]/2))
        title_font = font.SysFont(self.text_size_font, round(self.__text_size), bold=True)
        text_dimension = title_font.size(str(round(self.__size_circle_player)))
        Game.window_surface.blit(title_font.render(str(round(self.__size_circle_player)), True, self.text_size_color),
                                 (self.__player_circle_coords[0]-text_dimension[0]/2, self.__player_circle_coords[1]+text_dimension[1]))
        ...
        for dynamic_circle in DynamicCircles.dynamic_circle_objects:
            for dangerous_circle in DangerousCircles.dangerous_circle_objects:
                ...
                if distance_between_circles - (
                        ...
                        dynamic_circle.speed = DynamicCircles.choose_speed()
